...
class Itactica_Intenso_Helper_Data extends Mage_Core_Helper_Abstract
{
     ...
     * @return bool
     */
    public function getRecentlyViewedMinWidth() {
        $store = Mage::app()->getStore();
        return Mage::getStoreConfig('intenso/recently_viewed/minimum_width', $store);
    }

    /**
     * @return bool
     */
    public function getRecentlyViewedAnimationSpeed() {
        $store = Mage::app()->getStore();
        return Mage::getStoreConfig('intenso/recently_viewed/animation_speed', $store);
    }
