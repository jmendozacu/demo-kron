 ...
 * 
 */
var fullpagecache_Loader = Class.create({
    isDataLoaded: false,    
    data: null,
    config : {
        blockClass: 'glace-fullpagecache-loadable-block',
        loadingEffectClass: 'glace-fullpagecache-loading-effect',
        disabledCacheBlocks: [],
    ...
    {
        return this.read_cookie('glaceloadmon_loadlevel');
    },
    process: function() {
