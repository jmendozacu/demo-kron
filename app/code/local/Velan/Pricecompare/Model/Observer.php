...
require_once(Mage::getBaseDir() . '/lib/simpledomhtml/simple_html_dom.php');

class Velan_Pricecompare_Model_Observer
{
	
	public function priceCompareUpdate(){
		
		$url = Mage::getBaseUrl() . "pricecompare/";
...
EOH;
	...
	/*
	private function fetchPrice($htmls, $link, $selector, $elementPosition){
		
		
			$link = "https://www.konga.com/clip-on-mp3-player-1714844";
			echo "<pre>";
			echo "<br />" . $link . "<br />";
