...
class AW_Autorelated_Adminhtml_Awautorelated_ProductblockController extends AW_Autorelated_Adminhtml_Awautorelated_AbstractblockController
{
    ...
    {
        $this->_redirect('adminhtml/awautorelated_blocksgrid/list');
    }
    ...
    {
        return $this->_redirect('*/awautorelated_blocksgrid/delete', array(
            'id' => $this->getRequest()->getParam('id')
        ));
    }
}