...
class Fooman_Connect_Model_DataSource_OrderItem_Abstract extends Fooman_Connect_Model_DataSource_Abstract
{
    ...
    public function getDiscountPercent($base)
    {
        ...
        } elseif (Mage::getStoreConfig('tax/calculation/apply_after_discount', $this->getItem()->getStoreId()) == 1) {
    ...
    protected function _getTaxRateFromItem($item)
    {
        ...
        return $taxCollection->getFirstItem()->getXeroRate();
    }
    ...
    {
        return file_exists(
            Mage::getConfig()->getModuleDir('', 'Mage_Tax') . DS . 'Model' . DS . 'Sales' . DS . 'Tax' . DS . 'Item.php'
        );
    }
}
