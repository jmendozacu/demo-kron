 ...
 */
class Magestore_Madapter_Block_Adminhtml_Pem_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
	public function __construct(){
		...
		$this->_updateButton('save', 'label', Mage::helper('madapter')->__('Save'));
		// $this->_updateButton('delete', 'label', Mage::helper('madapter')->__('Delete'));
	...
	public function getHeaderText(){
		// if(Mage::registry('pem_data') && Mage::registry('pem_data')->getId())
			// return Mage::helper('madapter')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('madapter_data')->getTitle()));
		return Mage::helper('madapter')->__('Upload PEM file');
	}
}