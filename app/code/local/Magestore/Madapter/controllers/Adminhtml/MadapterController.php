 ...
 */
class Magestore_Madapter_Adminhtml_MadapterController extends Mage_Adminhtml_Controller_Action {
    ...
    protected function _initAction() {
        $this->loadLayout()
                ->_setActiveMenu('madapter/madapter')
    ...
    public function editAction() {
        ...
        if ($model->getId() || $id == 0) {
            ...
            $this->_addContent($this->getLayout()->createBlock('madapter/adminhtml_madapter_edit'))
                    ->_addLeft($this->getLayout()->createBlock('madapter/adminhtml_madapter_edit_tabs'));
    ...
    public function saveAction() {
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                $model->save();
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('madapter')->__('Item was successfully saved'));
