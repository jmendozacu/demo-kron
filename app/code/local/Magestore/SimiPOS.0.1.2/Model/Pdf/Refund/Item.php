 ...
 */
class Magestore_SimiPOS_Model_Pdf_Refund_Item extends Mage_Sales_Model_Order_Pdf_Items_Abstract
{
    /**
	...
	public function draw()
	{
        ...
        if ($this->getOrderItem($item)->getProductType() == 'bundle') {
        	// Render Bundle Item
        	$renderer = Mage::getSingleton('simipos/pdf_refund_bundle');
        ...
        // ID
        $itemData[] = (string)$item->getId();
        
        // Refund Qty
        $itemData[] = (float)$item->getQtyToRefund();
        
        // Show on Refund Form
        $itemData[] = (bool)$item->getQtyToRefund();
