...
class Devinc_Groupdeals_Model_Facebook_Session extends Varien_Object
{
    ...
    public function validate()
    {
		...
		$expectedSignature = hash_hmac('sha256', $this->_payload, Mage::getSingleton('groupdeals/facebook_config')->getSecret(), true);
		return ($expectedSignature==$this->_signature);
    }
     
    public function getCookie()
    {
    	return Mage::app()->getRequest()->getCookie('fbsr_'.Mage::getSingleton('groupdeals/facebook_config')->getApiKey(), false);
    }
