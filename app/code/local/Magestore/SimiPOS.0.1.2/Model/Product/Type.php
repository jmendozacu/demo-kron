 ...
 */
class Magestore_SimiPOS_Model_Product_Type extends Mage_Catalog_Model_Product_Type_Abstract
{
    public function prepareForCart(Varien_Object $buyRequest, $product = null)
    {
		...
		$result = $this->_prepareSimiPOSProduct($buyRequest,$product);
		return $result;
	}
    ...
    protected function _prepareSimiPOSProduct(Varien_Object $buyRequest, $product)
    {
