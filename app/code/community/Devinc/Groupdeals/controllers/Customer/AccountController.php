 ...
 */
class Devinc_Groupdeals_Customer_AccountController extends Mage_Core_Controller_Front_Action
{
    ...
    public function preDispatch()
    {
        ...
        if (!Mage::getSingleton('groupdeals/facebook_config')->isEnabled()) {
            $this->norouteAction();
            return;
        }
    }	
	...
	{
		return Mage::getSingleton('groupdeals/facebook_session');
	}
