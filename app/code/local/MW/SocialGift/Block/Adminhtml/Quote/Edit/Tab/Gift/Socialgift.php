<?php
class MW_SocialGift_Block_Adminhtml_Quote_Edit_Tab_Gift_Socialgift extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    {   
        parent::__construct();
        $this->setId('socialgift_product_grid');
    ...
    {
        return Mage::registry('current_socialgift_quote_rule');
    }
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('catalog/product')
            ...
            ->addFieldToFilter('type_id', array('eq' => 'simple')); // fill by simple product
