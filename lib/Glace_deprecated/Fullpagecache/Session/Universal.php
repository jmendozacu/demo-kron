...
class Glace_Fullpagecache_Session_Universal extends Glace_Fullpagecache_Session_Abstract
{
    ...
    {
        $booster = Glace_Fullpagecache_Mainpage::getInstance(dirname(dirname(dirname(dirname(dirname(__FILE__))))));
        ...
        if(is_null($this->_sessionRaw)) {
            ...
            switch($this->_sessionType) {
                case 'db':
                    ...
                    $className = 'Glace_Fullpagecache_Session_Mysql_'.$adapter;
            ...
            session_set_cookie_params($params['lifetime'], $params['path'], Glace_Fullpagecache_Mainpage::getInstance(null)->glaceGetCookieDomain());
