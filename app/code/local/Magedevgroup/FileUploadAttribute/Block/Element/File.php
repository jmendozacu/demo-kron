 ...
 */
class Magedevgroup_FileUploadAttribute_Block_Element_File extends Varien_Data_Form_Element_Abstract
{
    /**
     * Constructor
     *
    ...
    protected function _getDeleteCheckbox()
    {
        $html = '';
        if ($this->getValue()) {
            $label = Mage::helper('magedevgroup_fileuploadattribute')->__('Delete File');
