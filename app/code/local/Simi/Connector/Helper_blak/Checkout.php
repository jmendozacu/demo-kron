...
class Simi_Connector_Helper_Checkout extends Mage_Core_Helper_Abstract {
    ...
    public function convertBillingAddress($data) {
        ...
        $billing['taxvat'] = isset($data->billingAddress->taxvat) == true ? $data->billingAddress->taxvax : '';
    ...
    public function convertShippingAddress($data) {
        ...
        $shipping['taxvat'] = isset($data->shippingAddress->taxvat) == true ? $data->shippingAddress->taxvax : '';
