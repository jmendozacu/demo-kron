    ...
    public static function configure()
    {
        ...
        if (!$configured) {
            ...
            if (extension_loaded('pcntl')) {
                declare(ticks = 1);
                pcntl_signal(self::SIGINT, array('Aoe_Scheduler_Helper_GracefulDead', 'beforeDyingSigint')); // CTRL + C
                pcntl_signal(self::SIGTERM, array('Aoe_Scheduler_Helper_GracefulDead', 'beforeDyingSigterm')); // kill <pid>
            }
            $configured = true;
        }
    }
