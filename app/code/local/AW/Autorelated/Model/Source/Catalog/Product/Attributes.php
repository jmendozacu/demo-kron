...
class AW_Autorelated_Model_Source_Catalog_Product_Attributes extends AW_Autorelated_Model_Source_Abstract
{
    ...
    public function toOptionArray()
    {
        ...
        foreach ($attributesCollection as $attribute) {
            ...
            $_usedForRule = $attribute->isAllowedForRuleCondition() && $attribute->getDataUsingMethod('is_used_for_promo_rules');
            if ($_frontendLabel && $_usedForRule) {
        ...
        $attributes[] = array(
            'value' => 'category_ids',
            'label' => Mage::helper('catalogrule')->__('Category')
        );
