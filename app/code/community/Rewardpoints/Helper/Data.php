...
class Rewardpoints_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    public function getPointsOnOrder($cartLoaded = null, $cartQuote = null, $specific_rate = null, $exclude_rules = false, $storeId = false, $money_points = false){
        ...
        foreach ($items as $_item){
            ...
            if ($_item->getParentItemId()) {
                if ($_item->getParentItem()->getProduct()->getTypeId() == Mage_Catalog_Model_Product_Type::TYPE_BUNDLE && $_item->getParentItem()->getProduct()->getPrice()){
                    continue;
                }
            }
	    ...
	    if ($_item->getHasChildren() && ($_item->getProduct()->getTypeId() != Mage_Catalog_Model_Product_Type::TYPE_BUNDLE || $_item->getProduct()->getTypeId() == Mage_Catalog_Model_Product_Type::TYPE_BUNDLE && $_item->getProduct()->getPrice() == 0)){
